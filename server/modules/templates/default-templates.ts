 ...
 * 
 * Comprehensive collection of mining report templates including:
 * - International standards (JORC, NI43-101, SAMREC, PERC)
 * - Major mining companies (Vale, BHP, Rio Tinto, etc.)
 ...
 * Vale Template
 */
export const ValeTemplate: ReportTemplate = {
  ...
  sections: [
    ...
    {
      id: 'geology',
      title: 'Geology and Mineralization',
      order: 2,
      required: true,
      fields: [
        {
 ...
 * BHP Template
 */
export const BHPTemplate: ReportTemplate = {
 ...
 * Rio Tinto Template
 */
export const RioTintoTemplate: ReportTemplate = {
  ...
  company: 'Rio Tinto',
  version: '1.0',
  thumbnail: '/templates/rio-tinto.png',
...
/**
 * Additional company templates (simplified for brevity)
 */
export const GlencoreTemplate: ReportTemplate = {
  ...
  company: 'Glencore',
  version: '1.0',
  thumbnail: '/templates/glencore.png',
...
export const AngloAmericanTemplate: ReportTemplate = {
  ...
  version: '1.0',
  thumbnail: '/templates/anglo-american.png',
...
export const NewmontTemplate: ReportTemplate = {
  ...
  company: 'Newmont',
  version: '1.0',
  thumbnail: '/templates/newmont.png',
...
export const BarrickTemplate: ReportTemplate = {
  ...
  version: '1.0',
  thumbnail: '/templates/barrick.png',
...
export const KinrossTemplate: ReportTemplate = {
  ...
  version: '1.0',
  thumbnail: '/templates/kinross.png',
