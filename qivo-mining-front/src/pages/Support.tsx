...
export default function Support() {
 ...
 try {
 const response = await fetch(`${API_BASE_URL}/api/support/manual/${manual.id}?format=html`, {
 credentials: 'include',
 });
 ...
 try {
 const response = await fetch(`${API_BASE_URL}/api/support/search?q=${encodeURIComponent(query)}`, {
 credentials: 'include',
 });
