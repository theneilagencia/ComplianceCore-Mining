...
export default function RadarPageNew() {
  ...
  const fetchOperations = async () => {
    try {
      setLoading(true);
      const response = await fetch(`${API_BASE_URL}/api/radar/operations`, {
        credentials: 'include',
      });
  ...
  const fetchRegulatoryChanges = async () => {
    try {
      const response = await fetch(`${API_BASE_URL}/api/radar/regulatory-changes`, {
        credentials: 'include',
      });
  ...
  const fetchDiagnostic = async () => {
    try {
      const response = await fetch(`${API_BASE_URL}/api/radar/diagnostic`, {
        credentials: 'include',
      });
